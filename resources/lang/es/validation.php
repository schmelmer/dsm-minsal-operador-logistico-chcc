...
return [
    'required_poblacion' =>  'La población es requerida cuando no aplica a Servicio de Salud y SEREMI de Salud u Hospital',
    ...
    */
    ...
    'custom' => [
        'poblacion_id' => [
            'required_if' => 'La población es requerida cuando no aplica a Servicio de Salud y SEREMI de Salud u Hospital',
        ],
        'recaptcha' => [
            'required' => 'Por favor, confirme que no es un robot!',
            'captcha'  => 'Captcha error! intente nuevamente',
        ],
    ],
