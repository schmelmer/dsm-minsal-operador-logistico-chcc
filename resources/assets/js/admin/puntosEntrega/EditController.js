module.exports = function (data, regiones, region, responsables, territorios, RegionService, ServicioSaludService, ComunaService, PuntoEntregaService, $state, toastr, $stateParams) {
  'ngInject';
  var vm = this;
  vm.action = 'Editar';
  vm.data =  data;
  ...
  vm.establecimientos = _.get(_.find(vm.comunas, {id: data.comuna_id}), 'establecimientos', []);
