module.exports = function (regiones, responsables, territorios, RegionService, ServicioSaludService, ComunaService, PuntoEntregaService, $state, toastr, EstimacionService, PleaseWaitFactory) {
  'ngInject';
  var vm = this;
  vm.action = 'Crear';
  vm.errors = {};
  ...
  this.submitForm = function () {
    ...
    PuntoEntregaService.createResource(vm.data)
      .then(function(data) {
        ...
        EstimacionService.calculaEstimaciones().then(function(response) {
